...
function Alert() {
  const [show, type, content, duration, setShow] = AlertStore(s => [s.show, s.type, s.content, s.duration, s.setShow], shallow)
  ...
  return (
    <AnimatePresence>
      {show
        && <motion.div
          className={clsx('fixed w-[30%] max-w-[500px] top-[8%] left-[35%] z-[100]')}
